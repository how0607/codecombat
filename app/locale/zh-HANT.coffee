module.exports = nativeDescription: "繁體中文", englishDescription: "Chinese (Traditional)", translation:
  new_home:
    ...
    codecombat_is: "CodeCombat 是一個讓<strong>學生</strong>透過進行遊戲來學習計算機科學的平台。"
    our_courses: "我們的課程經過特別的遊戲測試來<strong>超越教室教學</strong>，甚至是超越一些先前沒有編程經驗的老師。"
    watch_how: "看 CodeCombat 如何改變人們學習計算機科學的方式。"#"Watch how CodeCombat is transforming the way people learn computer science."
...
#    removing_course: "Removing course"
    ...
    practice: "練習"
    started: "已開始"
    click_to_view_progress: "點擊來觀看進度"
    no_progress: "無進度"
    not_required: "不需要"
